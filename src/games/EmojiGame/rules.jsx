...
import Iridescence from "../../components/ui/wavebg";// ✅ Import the background animation
...
function ERules() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      {/* ✅ Iridescence Background Behind Everything */}
      <Iridescence
      ...
      <div className="relative z-10 min-h-screen flex justify-center items-center p-4 ">
        <div className="rounded-2xl max-w-5xl w-full p-6 md:p-10 relative bg-white shadow-lg">
          {/* Back Button */}
          <button
            onClick={() => navigate("/")}
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            {/* Right Side - Rules */}
            <div className="w-full md:w-1/2 text-gray-800 bg-white/10 backdrop-blur-md rounded-xl p-4">
